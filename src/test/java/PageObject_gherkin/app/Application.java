package PageObject_gherkin.app;

import PageObject_gherkin.pages.Page_basket;
import PageObject_gherkin.pages.Page_main;
import PageObject_gherkin.pages.Page_product;
...
//          // откроем первый продукт
    ...
    public void check_main_page(){
        String title_of_page = page_main.title_of_page();
        Assert.assertEquals(title_of_page, "Online Store | My Store");
    }
}
